...
function Products({searchKey="", sortType="", sortOrder="", isCart=false, isFavorite=false}) {
  ...
  (k)=> getProductsList({page: currentPage, searchKey, sortOrder, sortType, isCart, isFavorite, token}))
